...
SUPEE-10570_CE_v1.5.0.1 | CE_1.5.0.1 | v1 | 1bf4f720a9f49abcfe2e777e45fcf83ff8245ef8 | Tue Feb 27 23:42:48 2018 +0200 | ce-1.5.0.1-dev
...
+                $customer->setPasswordCreatedAt(time());
                 ...
                 return;
@@ -797,6 +798,7 @@ class Mage_Customer_AccountController extends Mage_Core_Controller_Front_Action
