...
SUPEE-10570_CE_v1.5.1.0 | CE_1.5.1.0 | v1 | 899832e4e18b5dba8fd66e0ec7b0b7894b30cd66 | Tue Feb 27 23:08:59 2018 +0200 | ce-1.5.1.0-dev

__PATCHFILE_FOLLOWS__
diff --git app/Mage.php app/Mage.php
index e197746..fe55810 100644
--- app/Mage.php
+++ app/Mage.php
...
index 76bc3fe..c0b8def 100644
--- app/code/core/Mage/Adminhtml/controllers/Catalog/ProductController.php
+++ app/code/core/Mage/Adminhtml/controllers/Catalog/ProductController.php
@@ -686,6 +686,16 @@ class Mage_Adminhtml_Catalog_ProductController extends Mage_Adminhtml_Controller
...
@@ -314,6 +316,26 @@ class Mage_Core_Model_Session_Abstract_Varien extends Varien_Object
     }
...
+    /**
      ...
      *
      * @return array
@@ -375,6 +397,23 @@ class Mage_Core_Model_Session_Abstract_Varien extends Varien_Object
...
@@ -409,6 +448,13 @@ class Mage_Core_Model_Session_Abstract_Varien extends Varien_Object
...
index a0dc924..2003fb0 100644
--- app/code/core/Mage/Customer/Helper/Data.php
+++ app/code/core/Mage/Customer/Helper/Data.php
@@ -315,4 +315,21 @@ class Mage_Customer_Helper_Data extends Mage_Core_Helper_Abstract
         }
         return $result;
     }
+
...
+                $customer->setPasswordCreatedAt(time());
                 ...
                 return;
@@ -802,6 +803,7 @@ class Mage_Customer_AccountController extends Mage_Core_Controller_Front_Action
...
diff --git app/code/core/Mage/Customer/sql/customer_setup/mysql4-upgrade-1.4.0.0.14.1.1-1.4.0.0.14.1.2.php app/code/core/Mage/Customer/sql/customer_setup/mysql4-upgrade-1.4.0.0.14.1.1-1.4.0.0.14.1.2.php
new file mode 100644
index 0000000..543bc81
--- /dev/null
+++ app/code/core/Mage/Customer/sql/customer_setup/mysql4-upgrade-1.4.0.0.14.1.1-1.4.0.0.14.1.2.php
@@ -0,0 +1,38 @@
+<?php
+/**
+ * Magento
...
diff --git app/code/core/Mage/Downloadable/sql/downloadable_setup/mysql4-upgrade-1.4.0.3.1.1-1.4.0.3.1.2.php app/code/core/Mage/Downloadable/sql/downloadable_setup/mysql4-upgrade-1.4.0.3.1.1-1.4.0.3.1.2.php
new file mode 100644
index 0000000..1965116
--- /dev/null
+++ app/code/core/Mage/Downloadable/sql/downloadable_setup/mysql4-upgrade-1.4.0.3.1.1-1.4.0.3.1.2.php
@@ -0,0 +1,35 @@
+<?php
+/**
+ * Magento
...
index ba2781b..b62c23f 100644
--- app/code/core/Mage/ImportExport/Model/Import.php
+++ app/code/core/Mage/ImportExport/Model/Import.php
@@ -343,6 +343,10 @@ class Mage_ImportExport_Model_Import extends Varien_Object
...
+        self::ERROR_INVALID_PRODUCT_SKU          => 'Invalid value in SKU column. HTML tags are not allowed'
     ...
     /**
@@ -553,6 +559,22 @@ class Mage_ImportExport_Model_Import_Entity_Product extends Mage_ImportExport_Mo
     }
...
@@ -1406,6 +1428,7 @@ class Mage_ImportExport_Model_Import_Entity_Product extends Mage_ImportExport_Mo
