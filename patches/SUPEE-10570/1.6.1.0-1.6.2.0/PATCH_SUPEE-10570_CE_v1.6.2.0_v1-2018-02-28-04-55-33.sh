...
SUPEE-10570_CE_v1.6.2.0 | CE_1.6.2.0 | v1 | f48b1f93b84d1d4a5dda5ccf85c81db6fff8a2c2 | Tue Feb 27 22:57:17 2018 +0200 | ce-1.6.2.0-dev

__PATCHFILE_FOLLOWS__
diff --git app/Mage.php app/Mage.php
index 82f84fb..86746dc 100644
--- app/Mage.php
+++ app/Mage.php
...
index 1ecb287..c1803c8 100644
--- app/code/core/Mage/Admin/Model/User.php
+++ app/code/core/Mage/Admin/Model/User.php
@@ -362,7 +362,7 @@ class Mage_Admin_Model_User extends Mage_Core_Model_Abstract
     /**
      * Login user
      *
-     * @param   string $login
+     * @param   string $username
      ...
      */
@@ -370,6 +370,7 @@ class Mage_Admin_Model_User extends Mage_Core_Model_Abstract
     {
...
@@ -318,6 +320,26 @@ class Mage_Core_Model_Session_Abstract_Varien extends Varien_Object
     }
...
+    /**
      ...
      *
      * @return array
@@ -379,6 +401,23 @@ class Mage_Core_Model_Session_Abstract_Varien extends Varien_Object
...
@@ -413,6 +452,13 @@ class Mage_Core_Model_Session_Abstract_Varien extends Varien_Object
...
index 541e726..471550e 100644
--- app/code/core/Mage/Customer/Helper/Data.php
+++ app/code/core/Mage/Customer/Helper/Data.php
@@ -346,4 +346,21 @@ class Mage_Customer_Helper_Data extends Mage_Core_Helper_Abstract
     {
...
+            <version>1.6.1.0.1.2</version>
     ...
     <admin>
diff --git app/code/core/Mage/Customer/sql/customer_setup/upgrade-1.6.1.0.1.1-1.6.1.0.1.2.php app/code/core/Mage/Customer/sql/customer_setup/upgrade-1.6.1.0.1.1-1.6.1.0.1.2.php
new file mode 100644
index 0000000..543bc81
--- /dev/null
+++ app/code/core/Mage/Customer/sql/customer_setup/upgrade-1.6.1.0.1.1-1.6.1.0.1.2.php
@@ -0,0 +1,38 @@
+<?php
+/**
+ * Magento
...
index f77bd18..eb880c5 100644
--- app/code/core/Mage/Widget/controllers/Adminhtml/Widget/InstanceController.php
+++ app/code/core/Mage/Widget/controllers/Adminhtml/Widget/InstanceController.php
@@ -164,7 +164,7 @@ class Mage_Widget_Adminhtml_Widget_InstanceController extends Mage_Adminhtml_Con
...
@@ -293,4 +293,20 @@ class Mage_Widget_Adminhtml_Widget_InstanceController extends Mage_Adminhtml_Con
     {
