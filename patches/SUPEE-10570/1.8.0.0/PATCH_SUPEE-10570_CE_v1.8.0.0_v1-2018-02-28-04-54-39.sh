...
SUPEE-10570_CE_v1.8.0.0 | CE_1.8.0.0 | v1 | 986bca0b2677f991a94d049cf0d50bb5095b4bd8 | Tue Feb 27 22:33:01 2018 +0200 | ce-1.8.0.0-dev

__PATCHFILE_FOLLOWS__
diff --git app/Mage.php app/Mage.php
index 5609842..95fb082 100644
--- app/Mage.php
+++ app/Mage.php
...
+     * @param   string $username
      ...
      */
@@ -380,6 +380,7 @@ class Mage_Admin_Model_User extends Mage_Core_Model_Abstract
     {
...
@@ -324,6 +326,26 @@ class Mage_Core_Model_Session_Abstract_Varien extends Varien_Object
     }
...
+    /**
      ...
      *
      * @return array
@@ -391,6 +413,23 @@ class Mage_Core_Model_Session_Abstract_Varien extends Varien_Object
             }
             return false;
         }
...
@@ -425,6 +464,13 @@ class Mage_Core_Model_Session_Abstract_Varien extends Varien_Object
...
@@ -840,6 +841,7 @@ class Mage_Customer_AccountController extends Mage_Core_Controller_Front_Action
...
@@ -986,6 +988,7 @@ class Mage_Customer_AccountController extends Mage_Core_Controller_Front_Action
...
index 310b1ca..7e5e61a 100644
--- app/code/core/Mage/ImportExport/Model/Import/Entity/Product.php
+++ app/code/core/Mage/ImportExport/Model/Import/Entity/Product.php
@@ -99,6 +99,11 @@ class Mage_ImportExport_Model_Import_Entity_Product extends Mage_ImportExport_Mo
...
+    const ERROR_INVALID_PRODUCT_SKU          = 'invalidSku';
     ...
     /**
@@ -188,7 +193,8 @@ class Mage_ImportExport_Model_Import_Entity_Product extends Mage_ImportExport_Mo
...
+        self::ERROR_INVALID_PRODUCT_SKU          => 'Invalid value in SKU column. HTML tags are not allowed'
     ...
     /**
@@ -663,6 +669,22 @@ class Mage_ImportExport_Model_Import_Entity_Product extends Mage_ImportExport_Mo
     }
...
@@ -1951,6 +1973,7 @@ class Mage_ImportExport_Model_Import_Entity_Product extends Mage_ImportExport_Mo
