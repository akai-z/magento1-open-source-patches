...
SUPEE-10570_CE_v1.9.2.2 | CE_1.9.2.2 | v1 | a2c5f2f5b48f8ac7688dfe4949a265e4624eff4e | Tue Feb 27 22:27:12 2018 +0200 | ce-1.9.2.2-dev

__PATCHFILE_FOLLOWS__
diff --git app/Mage.php app/Mage.php
index d09ae00..a2091e9 100644
--- app/Mage.php
+++ app/Mage.php
...
+    const VALIDATOR_PASSWORD_CREATE_TIMESTAMP   = 'password_create_timestamp';
     ...
     /**
@@ -383,6 +385,26 @@ class Mage_Core_Model_Session_Abstract_Varien extends Varien_Object
     }
...
+    /**
      ...
      *
      * @return array
@@ -450,6 +472,23 @@ class Mage_Core_Model_Session_Abstract_Varien extends Varien_Object
             }
             return false;
         }
...
@@ -484,6 +523,13 @@ class Mage_Core_Model_Session_Abstract_Varien extends Varien_Object
...
index 33a23a3..4ab77f5 100644
--- app/code/core/Mage/Customer/Helper/Data.php
+++ app/code/core/Mage/Customer/Helper/Data.php
@@ -686,6 +686,23 @@ class Mage_Customer_Helper_Data extends Mage_Core_Helper_Abstract
     }
