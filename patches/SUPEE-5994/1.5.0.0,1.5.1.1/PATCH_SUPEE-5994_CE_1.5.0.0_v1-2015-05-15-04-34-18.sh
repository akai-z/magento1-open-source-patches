...
SUPEE-5994 | CE_1.5.0.0 | v1 | _ | n/a | SUPEE-5994_CE_1.5.0.0_v1.patch
...
index 1a692bf..a2f4992 100644
--- get.php
+++ get.php
@@ -33,7 +33,7 @@ if (version_compare(phpversion(), '5.2.0', '<')===true) {
  * Error reporting
  */
