...
SUPEE-6285 | CE_1.4.1.0 | v1 | dc8cfdd51f54bd5f9185bfbefc19115a0f60f74a | Thu Jul 9 23:37:02 2015 +0300 | 5c08834f44..dc8cfdd51f

__PATCHFILE_FOLLOWS__
diff --git app/Mage.php app/Mage.php
index b1ce249..e4e8e30 100644
--- app/Mage.php
+++ app/Mage.php
...
index bdc3b10..676f846 100644
--- app/code/core/Mage/Adminhtml/controllers/Sales/Billing/AgreementController.php
+++ app/code/core/Mage/Adminhtml/controllers/Sales/Billing/AgreementController.php
@@ -201,7 +201,8 @@ class Mage_Adminhtml_Sales_Billing_AgreementController extends Mage_Adminhtml_Co
      */
     protected function _isAllowed()
     {
-        switch ($this->getRequest()->getActionName()) {
...
index 6778d34..1bfa5a3 100644
--- app/code/core/Mage/Core/Block/Abstract.php
+++ app/code/core/Mage/Core/Block/Abstract.php
@@ -1030,6 +1030,19 @@ abstract class Mage_Core_Block_Abstract extends Varien_Object
     }
