...
SUPEE-6788 | CE_1.4.0.1 | v1 | 27a27dcf518f94202a4ec80b9ed0257ed8620212 | Fri Oct 30 09:48:30 2015 +0200 | 1ddf1b0
...
index 96ebdd2..252ad40 100644
--- app/code/core/Mage/Catalog/Model/Product/Option/Type/File.php
+++ app/code/core/Mage/Catalog/Model/Product/Option/Type/File.php
@@ -254,7 +254,13 @@ class Mage_Catalog_Model_Product_Option_Type_File extends Mage_Catalog_Model_Pro
...
@@ -270,7 +276,7 @@ class Mage_Catalog_Model_Product_Option_Type_File extends Mage_Catalog_Model_Pro
     {
...
@@ -281,7 +287,13 @@ class Mage_Catalog_Model_Product_Option_Type_File extends Mage_Catalog_Model_Pro
                 );
 
                 $this->_formattedOptionValue = $this->_getOptionHtml($value);
-                $this->getQuoteItemOption()->setValue(serialize($value));
+                $quoteItemOptionValue = serialize($value);
+                try {
+                    Mage::helper('core/unserializeArray')->unserialize($quoteItemOptionValue);
+                } catch (Exception $e) {
+                    Mage::throwException(Mage::helper('catalog')->__("File options format is not valid."));
+                }
+                $this->getQuoteItemOption()->setValue($quoteItemOptionValue);
                 return $this->_formattedOptionValue;
 
             } catch (Exception $e) {
@@ -300,7 +312,7 @@ class Mage_Catalog_Model_Product_Option_Type_File extends Mage_Catalog_Model_Pro
...
@@ -340,7 +352,7 @@ class Mage_Catalog_Model_Product_Option_Type_File extends Mage_Catalog_Model_Pro
...
@@ -365,7 +377,6 @@ class Mage_Catalog_Model_Product_Option_Type_File extends Mage_Catalog_Model_Pro
...
-                unserialize($option->getValue());
                 ...
                 return null;
@@ -384,7 +395,7 @@ class Mage_Catalog_Model_Product_Option_Type_File extends Mage_Catalog_Model_Pro
...
+            $result = Mage::helper('core/unserializeArray')->unserialize($optionValue);
             ...
             return null;
@@ -400,7 +411,7 @@ class Mage_Catalog_Model_Product_Option_Type_File extends Mage_Catalog_Model_Pro
     {
...
index cd6fdc8..331cf65 100644
--- app/code/core/Mage/Core/Controller/Request/Http.php
+++ app/code/core/Mage/Core/Controller/Request/Http.php
@@ -284,11 +284,19 @@ class Mage_Core_Controller_Request_Http extends Zend_Controller_Request_Http
...
index 25d59b6..a56d3bf 100644
--- app/code/core/Mage/Core/Controller/Varien/Router/Admin.php
+++ app/code/core/Mage/Core/Controller/Varien/Router/Admin.php
@@ -88,6 +88,27 @@ class Mage_Core_Controller_Varien_Router_Admin extends Mage_Core_Controller_Vari
     }
...
+        $this->_permissionBlock = Mage::getModel('admin/block');
     ...
     /**
@@ -159,8 +167,10 @@ class Mage_Core_Model_Email_Template_Filter extends Varien_Filter_Template
...
+            }
             ...
             if ($block) {
@@ -460,7 +470,7 @@ class Mage_Core_Model_Email_Template_Filter extends Varien_Filter_Template
         $configValue = '';
...
index 3eef902..bf481af 100644
--- app/code/core/Mage/Core/Model/Resource/Setup.php
+++ app/code/core/Mage/Core/Model/Resource/Setup.php
@@ -370,7 +370,6 @@ class Mage_Core_Model_Resource_Setup
                         }
                     }
                 } catch (Exception $e){
...
index 7bb5c09..635f9d7 100644
--- app/code/core/Mage/Customer/controllers/AccountController.php
+++ app/code/core/Mage/Customer/controllers/AccountController.php
@@ -244,12 +244,17 @@ class Mage_Customer_AccountController extends Mage_Core_Controller_Front_Action
      */
...
@@ -317,7 +322,7 @@ class Mage_Customer_AccountController extends Mage_Core_Controller_Front_Action
...
@@ -330,10 +335,9 @@ class Mage_Customer_AccountController extends Mage_Core_Controller_Front_Action
...
index c5d7f02..020293d 100644
--- app/code/core/Mage/Sales/controllers/DownloadController.php
+++ app/code/core/Mage/Sales/controllers/DownloadController.php
@@ -47,12 +47,14 @@ class Mage_Sales_DownloadController extends Mage_Core_Controller_Front_Action
         if ($option->getId()) {
...
@@ -85,4 +87,17 @@ class Mage_Sales_DownloadController extends Mage_Core_Controller_Front_Action
...
index 264d5d3..6252ed2 100644
--- errors/processor.php
+++ errors/processor.php
@@ -446,6 +446,7 @@ class Error_Processor
...
index 0b4d2223..310d932 100644
--- lib/Varien/Data/Collection/Db.php
+++ lib/Varien/Data/Collection/Db.php
@@ -354,8 +354,14 @@ class Varien_Data_Collection_Db extends Varien_Data_Collection
      */
...
+        }
+
+        $this->_select->where($this->_getConditionSql($quotedField, $condition));
         return $this;
     }
 
@@ -403,7 +409,7 @@ class Varien_Data_Collection_Db extends Varien_Data_Collection
