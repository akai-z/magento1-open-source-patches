...
SUPEE-6788 | CE_1.4.2.0 | v1 | 357931bd6aab40f864be0430db9774b3c0c456e2 | Fri Oct 30 09:48:30 2015 +0200 | e2856ba
...
index 1ee2ba4..56ced5f 100644
--- app/code/core/Mage/Catalog/Model/Product/Option/Type/File.php
+++ app/code/core/Mage/Catalog/Model/Product/Option/Type/File.php
@@ -262,7 +262,13 @@ class Mage_Catalog_Model_Product_Option_Type_File extends Mage_Catalog_Model_Pro
...
@@ -278,7 +284,7 @@ class Mage_Catalog_Model_Product_Option_Type_File extends Mage_Catalog_Model_Pro
     {
...
@@ -290,7 +296,13 @@ class Mage_Catalog_Model_Product_Option_Type_File extends Mage_Catalog_Model_Pro
...
@@ -309,7 +321,7 @@ class Mage_Catalog_Model_Product_Option_Type_File extends Mage_Catalog_Model_Pro
...
@@ -349,7 +361,7 @@ class Mage_Catalog_Model_Product_Option_Type_File extends Mage_Catalog_Model_Pro
...
@@ -374,7 +386,6 @@ class Mage_Catalog_Model_Product_Option_Type_File extends Mage_Catalog_Model_Pro
...
-                unserialize($option->getValue());
                 ...
                 return null;
@@ -393,7 +404,7 @@ class Mage_Catalog_Model_Product_Option_Type_File extends Mage_Catalog_Model_Pro
...
+            $result = Mage::helper('core/unserializeArray')->unserialize($optionValue);
             ...
             return null;
@@ -409,7 +420,7 @@ class Mage_Catalog_Model_Product_Option_Type_File extends Mage_Catalog_Model_Pro
     {
...
@@ -89,7 +91,7 @@ class Mage_Sales_DownloadController extends Mage_Core_Controller_Front_Action
 
         $orderItemInfo = $recurringProfile->getData('order_item_info');
         try {
-            $request = unserialize($orderItemInfo['info_buyRequest']);
+            $request = Mage::helper('core/unserializeArray')->unserialize($orderItemInfo['info_buyRequest']);
             if (!isset($request['options'][$this->getRequest()->getParam('option_id')])) {
                 $this->_forward('noRoute');
                 return;
@@ -115,10 +117,23 @@ class Mage_Sales_DownloadController extends Mage_Core_Controller_Front_Action
             $this->_forward('noRoute');
         }
         try {
...
index 0d231f5..53f5179 100644
--- lib/Varien/Data/Collection/Db.php
+++ lib/Varien/Data/Collection/Db.php
@@ -365,8 +365,14 @@ class Varien_Data_Collection_Db extends Varien_Data_Collection
      */
...
@@ -414,7 +420,7 @@ class Varien_Data_Collection_Db extends Varien_Data_Collection
