...
SUPEE-6788 | CE_1.6.2.0 | v1 | ba4ae17ba0ef0baf204e2d616a428713d29e7968 | Tue Oct 27 13:15:35 2015 +0200 | baba978

__PATCHFILE_FOLLOWS__
diff --git .htaccess .htaccess
index 9acb08b..70841ac 100644
--- .htaccess
+++ .htaccess
@@ -184,3 +184,28 @@
...
+
         if ($fileInfo !== null) {
             if (is_array($fileInfo) && $this->_validateFile($fileInfo)) {
                 $value = $fileInfo;
@@ -452,6 +444,11 @@ class Mage_Catalog_Model_Product_Option_Type_File extends Mage_Catalog_Model_Pro
...
@@ -482,7 +479,7 @@ class Mage_Catalog_Model_Product_Option_Type_File extends Mage_Catalog_Model_Pro
     {
...
@@ -544,7 +541,7 @@ class Mage_Catalog_Model_Product_Option_Type_File extends Mage_Catalog_Model_Pro
         if (is_array($value)) {
             return $value;
...
@@ -570,7 +567,7 @@ class Mage_Catalog_Model_Product_Option_Type_File extends Mage_Catalog_Model_Pro
...
@@ -595,7 +592,6 @@ class Mage_Catalog_Model_Product_Option_Type_File extends Mage_Catalog_Model_Pro
...
-                unserialize($option->getValue());
                 ...
                 return null;
@@ -614,7 +610,7 @@ class Mage_Catalog_Model_Product_Option_Type_File extends Mage_Catalog_Model_Pro
...
+            $result = Mage::helper('core/unserializeArray')->unserialize($optionValue);
             ...
             return null;
@@ -630,7 +626,7 @@ class Mage_Catalog_Model_Product_Option_Type_File extends Mage_Catalog_Model_Pro
     {
...
+            'changeforgotten',
             ...
             'resetpasswordpost',
             'confirm',
@@ -257,12 +261,17 @@ class Mage_Customer_AccountController extends Mage_Core_Controller_Front_Action
      */
...
@@ -354,7 +363,7 @@ class Mage_Customer_AccountController extends Mage_Core_Controller_Front_Action
...
@@ -365,9 +374,8 @@ class Mage_Customer_AccountController extends Mage_Core_Controller_Front_Action
...
@@ -572,21 +580,37 @@ class Mage_Customer_AccountController extends Mage_Core_Controller_Front_Action
     /**
...
+
             ...
             $this->_getSession()->addError(Mage::helper('customer')->__('Your password reset link has expired.'));
             $this->_redirect('*/*/forgotpassword');
@@ -601,10 +625,9 @@ class Mage_Customer_AccountController extends Mage_Core_Controller_Front_Action
      */
...
+        $passwordConfirmation = (string)$this->getRequest()->getPost('confirmation');
         ...
         try {
             $this->_validateResetPasswordLinkToken($customerId, $resetPasswordLinkToken);
@@ -633,10 +656,7 @@ class Mage_Customer_AccountController extends Mage_Core_Controller_Front_Action
...
@@ -646,14 +666,15 @@ class Mage_Customer_AccountController extends Mage_Core_Controller_Front_Action
...
@@ -819,4 +840,34 @@ class Mage_Customer_AccountController extends Mage_Core_Controller_Front_Action
...
@@ -433,7 +439,7 @@ class Varien_Data_Collection_Db extends Varien_Data_Collection
