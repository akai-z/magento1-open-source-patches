...
SUPEE-6788 | CE_1.9.1.0 | v1 | 3359622576c5907dff1346ed2edfcbbcc89703ca | Fri Oct 16 14:10:05 2015 +0300 | 45a4095
...
index c858b46..8c35f53 100644
--- app/code/core/Mage/Core/Controller/Varien/Router/Admin.php
+++ app/code/core/Mage/Core/Controller/Varien/Router/Admin.php
@@ -131,6 +131,23 @@ class Mage_Core_Controller_Varien_Router_Admin extends Mage_Core_Controller_Vari
     }
...
+    {
+        if ($frontName == (string)Mage::getConfig()->getNode(Mage_Adminhtml_Helper_Data::XML_PATH_ADMINHTML_ROUTER_FRONTNAME)) {
